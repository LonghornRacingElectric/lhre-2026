...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB0     ------> ADC3_IN12
    */
    GPIO_InitStruct.Pin = SNS_TSSI_G_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SNS_TSSI_G_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA9     ------> ADC5_IN2
    */
    GPIO_InitStruct.Pin = BSE_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BSE_3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB0     ------> ADC3_IN12
    */
    HAL_GPIO_DeInit(SNS_TSSI_G_GPIO_Port, SNS_TSSI_G_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    HAL_GPIO_DeInit(BSE_3_GPIO_Port, BSE_3_Pin);
