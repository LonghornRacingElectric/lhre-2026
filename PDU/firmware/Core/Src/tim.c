...
void MX_TIM20_Init(void)
{
  ...
  htim20.Init.Prescaler = 95;
  htim20.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim20.Init.Period = 399;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA2     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = PWM_TSSI_R_Pin|PWM_TSSI_G_Pin;
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = PWM_BRAKEL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(PWM_BRAKEL_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM20_MspPostInit 0 */
    ...
    PF2     ------> TIM20_CH3
    */
    GPIO_InitStruct.Pin = PWM_LL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM20;
    HAL_GPIO_Init(PWM_LL_GPIO_Port, &GPIO_InitStruct);
