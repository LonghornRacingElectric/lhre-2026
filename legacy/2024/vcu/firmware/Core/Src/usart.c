...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PB9     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = GPS_RTK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART4;
    HAL_GPIO_Init(GPS_RTK_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END UART7_MspInit 0 */
    ...
    PB4     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = CELL_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_UART7;
    HAL_GPIO_Init(CELL_UART_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CELL_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_UART7;
    HAL_GPIO_Init(CELL_UART_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PA10     ------> LPUART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, EDGE_UART_TX_Pin|EDGE_UART_RX_Pin);
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PB9     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPS_RTK_GPIO_Port, GPS_RTK_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PB4     ------> UART7_TX
    */
    HAL_GPIO_DeInit(CELL_UART_RX_GPIO_Port, CELL_UART_RX_Pin);

    HAL_GPIO_DeInit(CELL_UART_TX_GPIO_Port, CELL_UART_TX_Pin);
...
/* USER CODE BEGIN 1 */
bool gps_completeLine = false;
char gps_currLine[MAX_GPS_LINE_SIZE] = {0};
uint16_t gps_currLineSize = 0;
char gps_tempLine[BUF_SIZE] = {0};
uint16_t gps_tempLineSize = 0;
    ...
    if(huart->Instance == USART1) { // If the DMA has finished receiving data
      ...
      if(gps_tempLine[gps_tempLineSize - 1] == '\n') {
          ...
          if (error != 0) {
            ...
            FAULT_CLEAR(&faultVector, FAULT_VCU_GPS_NO_DMA_START);
          }
      } else {
