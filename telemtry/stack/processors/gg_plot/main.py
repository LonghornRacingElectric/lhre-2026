...
logging.info("Kafka Producer initialized. Ready to send messages to 'gg-plot' topic.")
            ...
            for record in records:
                ...
                try:
                    ...
                    if not accel_data or len(accel_data) < 2:
                        logging.debug("  Warning: Missing or incomplete vcuAccel data.")
                        continue
                    ...
                    logging.debug(f"Sent filtered data to 'gg-plot': {filtered_message}")
