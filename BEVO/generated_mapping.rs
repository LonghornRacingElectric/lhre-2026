...
pub fn update_proto_field_generated(data: &mut OrionSensorData, name: &str, val: f32, config: &ProtobufMapping) {
    ...
    let _board_status = data.board_status.get_or_insert_with(Default::default);

    if config.repeated {
        if let Some(i) = config.field_index {
            match name {
                "bl_gyro" => crate::set_vec_index(&mut _d.bl_gyro, i, val),
                ...
                "br_gyro" => crate::set_vec_index(&mut _d.br_gyro, i, val),
                ...
                "fl_gyro" => crate::set_vec_index(&mut _d.fl_gyro, i, val),
                ...
                "fr_gyro" => crate::set_vec_index(&mut _d.fr_gyro, i, val),
        ...
        match name {
            ...
            "apps1_disconnect" => _h.apps1_disconnect = val != 0.0,
            "apps1_out_range" => _h.apps1_out_range = val != 0.0,
            "apps1_travel" => _c.apps1_travel = val,
            "apps1_v" => _c.apps1_v = val,
            "apps2_disconnect" => _h.apps2_disconnect = val != 0.0,
            "apps2_out_range" => _h.apps2_out_range = val != 0.0,
            "apps2_travel" => _c.apps2_travel = val,
            "apps2_v" => _c.apps2_v = val,
            "apps_implause" => _h.apps_implause = val != 0.0,
            "apps_mismatch" => _h.apps_mismatch = val != 0.0,
            "batt_cooling_current" => _t.batt_cooling_current = val,
            "batt_fans_fuse" => _h.batt_fans_fuse = val != 0.0,
            ...
            "batt_pump_fuse" => _h.batt_pump_fuse = val != 0.0,
            ...
            "bl_wheel_speed" => _d.bl_wheel_speed = val,
            "bmb_comm_error" => _l.bmb_comm_error = val != 0.0,
            "bms_led" => _t.bms_led = val != 0.0,
            "boards_fuse" => _h.boards_fuse = val != 0.0,
            "bpps1_disconnect" => _h.bpps1_disconnect = val != 0.0,
            "bpps1_out_range" => _h.bpps1_out_range = val != 0.0,
            "bpps1_travel" => _c.bpps1_travel = val,
            "bpps1_v" => _c.bpps1_v = val,
            "bpps2_disconnect" => _h.bpps2_disconnect = val != 0.0,
            "bpps2_out_range" => _h.bpps2_out_range = val != 0.0,
            "bpps2_travel" => _c.bpps2_travel = val,
            "bpps2_v" => _c.bpps2_v = val,
            "bpps_mismatch" => _h.bpps_mismatch = val != 0.0,
            "br_ride_height" => _d.br_ride_height = val,
            "br_strain_gauge_v" => _d.br_strain_gauge_v = val,
            "br_sus_pot_v" => _d.br_sus_pot_v = val,
            "br_wheel_speed" => _d.br_wheel_speed = val,
            "brake_bias" => _c.brake_bias = val,
            "brake_light_fuse" => _h.brake_light_fuse = val != 0.0,
            ...
            "bse1_disconnect" => _h.bse1_disconnect = val != 0.0,
            "bse1_out_range" => _h.bse1_out_range = val != 0.0,
            ...
            "charger_current" => _l.charger_current = val,
            "charger_enable" => _t.charger_enable = val != 0.0,
            "charger_enabled" => _l.charger_enabled = val != 0.0,
            "charger_voltage" => _l.charger_voltage = val,
            ...
            "line_lock_enabled" => _c.line_lock_enabled = val != 0.0,
            "ll_fuse" => _h.ll_fuse = val != 0.0,
            "lv_batt_c" => _p.lv_batt_c = val,
            "lv_batt_t" => _p.lv_batt_t = val,
            "lv_batt_v" => _p.lv_batt_v = val,
            "lv_boards_current" => _p.lv_boards_current = val,
            "max_cell_voltage" => _t.max_cell_voltage = val,
            "max_charge_current" => _t.max_charge_current = val,
            "max_charge_voltage" => _t.max_charge_voltage = val,
            "min_cell_voltage" => _t.min_cell_voltage = val,
            ...
            "motor_pump_fuse" => _h.motor_pump_fuse = val != 0.0,
            ...
            "prndl_state" => _h.prndl_state = val,
            ...
            "shtdn_fuse" => _h.shtdn_fuse = val != 0.0,
            "shutdown_bspd_status" => _h.shutdown_bspd_status = val != 0.0,
            "shutdown_current" => _h.shutdown_current = val,
            "shutdown_emeter_status" => _h.shutdown_emeter_status = val != 0.0,
            ...
            "soc_estimate" => _p.soc_estimate = val,
            "spare_fuse" => _h.spare_fuse = val != 0.0,
            "steer_col_angle" => _d.steer_col_angle = val,
            "stomp_fault" => _h.stomp_fault = val != 0.0,
            "temp_ams_1" => _t.temp_ams_1 = val != 0.0,
            "temp_ams_2" => _t.temp_ams_2 = val != 0.0,
            "temp_command_1" => _t.temp_command_1 = val != 0.0,
            "temp_command_2" => _t.temp_command_2 = val != 0.0,
            "temp_imd_1" => _l.temp_imd_1 = val != 0.0,
            "temp_imd_2" => _l.temp_imd_2 = val != 0.0,
            "temp_output_1" => _t.temp_output_1 = val != 0.0,
            "temp_output_2" => _t.temp_output_2 = val != 0.0,
            "temp_shutdown_1" => _l.temp_shutdown_1 = val != 0.0,
            "temp_shutdown_2" => _l.temp_shutdown_2 = val != 0.0,
            "time_since_on" => _p.time_since_on = val,
            "torque_command" => _c.torque_command = val,
            "torque_derated" => _c.torque_derated = val,
            "torque_feedback" => _c.torque_feedback = val,
            "torque_limit" => _c.torque_limit = val,
            "torque_lookup" => _c.torque_lookup = val,
            "torque_power_limited" => _c.torque_power_limited = val,
            "torque_request" => _c.torque_request = val,
            "torque_shudder" => _c.torque_shudder = val,
            "torque_traction_controlled" => _c.torque_traction_controlled = val,
            "tssi_green_fuse" => _h.tssi_green_fuse = val != 0.0,
            "tssi_red_fuse" => _h.tssi_red_fuse = val != 0.0,
