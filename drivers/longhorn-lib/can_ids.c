...
int pack_battery_cell_limits(const msg_battery_cell_limits_t* msg, uint8_t* tx_buf) {
    ...
    uint8_t raw_max_cell_voltage = (uint8_t)(msg->max_cell_voltage / 0.02f);
    tx_buf[2] = (uint8_t)raw_max_cell_voltage;
...
int unpack_battery_cell_limits(const uint8_t* rx_buf, msg_battery_cell_limits_t* msg) {
    ...
    uint8_t raw_max_cell_voltage = 0;
    raw_max_cell_voltage = (uint8_t)rx_buf[2];
    msg->max_cell_voltage = (float)raw_max_cell_voltage * 0.02f;
