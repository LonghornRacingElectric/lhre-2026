...
PYBIND11_MODULE(vcu_model_sim, m) {
  ...
  py::class_<debug_t>(outputs, "Debug")
      ...
      .def_readwrite("launch_active", &debug_t::launch_active)
      .def_readwrite("launch_state", &debug_t::launch_state)
      .def_readwrite("launch_raw_torque_cmd_nm",
                     &debug_t::launch_raw_torque_cmd_nm)
      .def_readwrite("launch_torque_cmd_nm",
                     &debug_t::launch_torque_cmd_nm);
  ...
  py::class_<torque_map_params_t>(params, "TorqueMapParams")
      ...
      .def_readwrite("launch_mode_disable",
                     &torque_map_params_t::launch_mode_disable)
      .def_readwrite("launch_enter_rpm",
                     &torque_map_params_t::launch_enter_rpm)
      .def_readwrite("launch_exit_rpm", &torque_map_params_t::launch_exit_rpm)
      .def_readwrite("launch_pedal_min",
                     &torque_map_params_t::launch_pedal_min)
      .def_readwrite("launch_pedal_max",
                     &torque_map_params_t::launch_pedal_max)
      .def_readwrite("launch_brake_min_psi",
                     &torque_map_params_t::launch_brake_min_psi)
      .def_readwrite("launch_preload_torque_nm",
                     &torque_map_params_t::launch_preload_torque_nm)
      .def_readwrite("launch_preload_ramp_rate_nm_per_s",
                     &torque_map_params_t::launch_preload_ramp_rate_nm_per_s)
      .def_readwrite("launch_release_ramp_rate_nm_per_s",
                     &torque_map_params_t::launch_release_ramp_rate_nm_per_s);
