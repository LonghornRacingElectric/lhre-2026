...
typedef struct {
  ...
  struct {
    ...
    bool launch_mode_disable;
    float launch_enter_rpm;
    float launch_exit_rpm;
    float launch_pedal_min;
    float launch_pedal_max;
    float launch_brake_min_psi;
    float launch_preload_torque_nm;
    float launch_preload_ramp_rate_nm_per_s;
    float launch_release_ramp_rate_nm_per_s;
  } torque_map;
