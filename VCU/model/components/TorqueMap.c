...
static const float torque_table[LOOKUP2D_POINTS_Y][LOOKUP2D_POINTS_X] = {
  /* rpm=    0 */ {   0.0f,  22.0f,  44.0f,  60.0f,  70.0f, 80.0f, 90.0f, 100.0f, 110.0f,  120.0f,  130.00f },
  /* rpm=  600 */ {   0.0f,  22.0f,  44.0f,  66.0f,  88.0f, 100.0f, 110.0f, 120.0f, 130.0f,  140.0f,  150.00f },
  /* rpm= 1200 */ {   0.0f,  22.0f,  44.0f,  66.0f,  88.0f, 110.0f, 120.0f, 130.0f, 150.0f,  170.0f,  190.00f },
