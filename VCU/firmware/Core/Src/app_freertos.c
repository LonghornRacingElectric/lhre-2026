    ...
    .torque_map =
        {
            ...
            .pedal_exponent = VCU_TORQUE_MAP_PEDAL_EXPONENT,
...
void StartControlTask(void *argument) {
  ...
  for (;;) {
    ...
    if (out.derate_factor_cell_voltage < 0.999f) {
    // log_printf(LOG_INFO,
    ...
    //          (double)out.derate_factor_cell_voltage,
